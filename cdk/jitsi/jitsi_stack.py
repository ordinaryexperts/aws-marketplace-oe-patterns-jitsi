...
AMI_ID="ami-01bd7c5e5add7222f"
AMI_NAME="ordinary-experts-patterns-jitsi-3.0.0-6-g6c42616-20240702-1224"
generated_ami_ids = {
    ...
    "us-east-1": "ami-01bd7c5e5add7222f"
}
...
class JitsiStack(Stack):
    ...
    def __init__(self, scope: Construct, id: str, **kwargs) -> None:
        ...
        aws_ec2.CfnSecurityGroupIngress(
            self,
            "NlbSgEtherpadIngress",
            cidr_ip=alb.ingress_cidr_param.value_as_string,
            description="Allow Etherpad traffic to NLB",
            from_port=9001,
            group_id=nlb_sg.ref,
            ip_protocol="tcp",
            to_port=9001
        ...
        nlb_etherpad_target_group = aws_elasticloadbalancingv2.CfnTargetGroup(
            self,
            "NlbEtherpadTargetGroup",
            port=9001,
            protocol="TCP",
            target_type="alb",
            targets=[aws_elasticloadbalancingv2.CfnTargetGroup.TargetDescriptionProperty(
        ...
        aws_elasticloadbalancingv2.CfnListener(
            ...
            default_actions=[
                aws_elasticloadbalancingv2.CfnListener.ActionProperty(
                    target_group_arn=nlb_etherpad_target_group.ref,
                    type="forward"
                )
            ],
            load_balancer_arn=nlb.ref,
