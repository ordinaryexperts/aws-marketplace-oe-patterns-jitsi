...
# make AMI_ID=ami-0d80ce20e36c1ade6 ami-ec2-copy
# on Sat Jul 10 07:04:41 UTC 2021.
AMI_ID="ami-00199b838e8e41ee3"
AMI_NAME="ordinary-experts-patterns-jitsi-1.0.4-83-gf303b1d-20210710-0650"
generated_ami_ids = {
    "us-east-2": "ami-039d73ed568b21b0c",
    "us-west-1": "ami-0e15bbfe62c4a6bca",
    "us-west-2": "ami-0cc39c6cdf2ddef37",
    "ca-central-1": "ami-06299085c54b494ee",
    "eu-central-1": "ami-00454c1e817cda5e5",
    "eu-north-1": "ami-0dbf982a75995982c",
    "eu-west-1": "ami-010f827224c3c0910",
    "eu-west-2": "ami-0274d81b18dd78ad4",
    "eu-west-3": "ami-036eb8e01c60a9a2b",
    "ap-northeast-1": "ami-02e7befa807c036b9",
    "ap-northeast-2": "ami-02542d857f6668fba",
    "ap-south-1": "ami-02201ff0adfbeb41f",
    "ap-southeast-1": "ami-09a0f6819e2c1421d",
    "ap-southeast-2": "ami-0aea832c8f52574a5",
    "sa-east-1": "ami-0c1470a0fca78126b",
    "us-east-1": "ami-00199b838e8e41ee3"
}
...
class JitsiStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        enable_debugging_param = core.CfnParameter(
            self,
            "EnableDebugging",
            allowed_values=[ "true", "false" ],
            default="false",
            description="Optional: Turn on debugging mode for the stack."
        )
        ...
        enable_debugging_condition = core.CfnCondition(
            self,
            "EnableDebuggingCondition",
            expression=core.Fn.condition_equals(enable_debugging_param.value, "true")
        )
